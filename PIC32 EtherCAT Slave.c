...
#define _PIC32_ETHER_CAT_SLAVE_ 1
#include "PIC32 EtherCAT Slave.h"
#undef _PIC32_ETHER_CAT_SLAVE_
/*--------------------------------------------------------------------------------------
------
...
\param     bCompleteAccess     Indicates if a complete read of all subindices of the
 ...
 \return    result of the read operation (0 (success) or an abort code (ABORTIDX_.... defined in
            sdosrv.h))
 *////////////////////////////////////////////////////////////////////////////////////////
UINT8 param2021_Read(UINT16 index, UINT8 subindex, UINT32 dataSize, UINT16 MBXMEM * pData, UINT8 bCompleteAccess) {
#if _WIN32
...
\param     bCompleteAccess     Indicates if a complete read of all subindices of the
 ...
 \return    result of the read operation (0 (success) or an abort code (ABORTIDX_.... defined in
            sdosrv.h))
 *////////////////////////////////////////////////////////////////////////////////////////
UINT8 param2021_Write(UINT16 index, UINT8 subindex, UINT32 dataSize, UINT16 MBXMEM * pData, UINT8 bCompleteAccess) {
#if _WIN32
